 ...
 *   6: Pint Instruction Error (Empty Stack)
 *   7: Pop Instruction Error (Empty Stack)
 *
 ...
 *   11: Can't Mul, Stack Too Short
 *   12: Can't Div, Stack Too Short
 *   13: Can't Mod, Stack Too Short
 *   14: Division by Zero
 *   15: Can't Pchar, Stack Empty
 *   16: Can't Pchar, Value Out of Range
 *
 * Prints error messages to stderr and exits with EXIT_FAILURE.
 */
